...
public class mensa extends RESTService {
  ...
  @Api
  @SwaggerDefinition(
      info = @Info(title = "348", version = "0.0.0",
          description = "",
          termsOfService = "",
          contact = @Contact(name = "", email = "CAEAddress@gmail.com") ,
          license = @License(name = "BSD",
              url = "https://github.com/GHProjectsTest/microservice-348/blob/master/LICENSE.txt") ) )
  @Path("/")
  ...
  public Response postDishRating(@PathParam("id") String id, String body) {
   ...
   try { 
    ...
    if(not_found_condition) {
      JSONObject not_found = new classes().new Dish Rating().toJSON();
